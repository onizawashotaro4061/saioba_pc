                ...
                <div className="border-t-2 border-gray-300 pt-6 sm:pt-8 space-y-6">
                  ...
                  {works && (
                    <div>
                      ...
                      <div className="bg-gray-50 p-4 sm:p-5 rounded-lg">
                        <p className="text-xs sm:text-sm md:text-base leading-relaxed text-gray-700 font-body-ja whitespace-pre-line">{works}</p>
                      </div>
                    </div>
                  )}
                </div>
